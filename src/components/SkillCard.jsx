...
const SkillCard = ({skill,percentage, color, move}) => {
  return <div className={`border border-[rgba(255,255,255,0.3)] rounded-md px-8 py-3 
  cursor-pointer group w-full flex items-center justify-between relative gap-2`}
  style={{ 
   ...
   <div className="flex-1 flex-col items-start justify-start flex gap-2">
    ...
    <div className="w-full h-1 rounded-md overflow-hidden bg-[rgba(255,255,255,0.2)] relative">
      <motion.div 
        ...
        className="h-full absolute top-0 left-0" style={{background: color}}>
